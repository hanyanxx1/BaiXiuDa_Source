...
-- -- 示例 1: 传条件导出，小分组前缀 'LLLL'，每批2万条，服务标识 '74'
-- CALL ExportDistinctGroupedCallData ( 'e_cdr_20260506', '/var/lib/mysql-files/', 'holdtime <= 0', 'LLLL', 20000, '74' );

-- -- 示例 2: 不传条件，查全表导出，小分组前缀 'LLLL'，每批2万条，服务标识 '74'
-- CALL ExportDistinctGroupedCallData ( 'e_cdr_20260506', '/var/lib/mysql-files/', '', 'LLLL', 20000, '74' );
