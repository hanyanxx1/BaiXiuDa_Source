...
-- 40
CALL ExportCallData('e_cdr_20250617', '/export_dir', 'holdtime >= 100');
CALL ExportCallData('e_cdr_20250618', '/export_dir', 'holdtime >= 100');
CALL ExportCallData('e_cdr_20250619', '/export_dir', 'holdtime >= 100');
CALL ExportCallData('e_cdr_20250620', '/export_dir', 'holdtime >= 100');
CALL ExportCallData('e_cdr_20250621', '/export_dir', 'holdtime >= 100');
CALL ExportCallData('e_cdr_20250622', '/export_dir', 'holdtime >= 100');
CALL ExportCallData('e_cdr_20250623', '/export_dir', 'holdtime >= 100');
CALL ExportCallData('e_cdr_20250624', '/export_dir', 'holdtime >= 100');
CALL ExportCallData('e_cdr_20250709', '/export_dir', 'holdtime >= 100');
CALL ExportCallData('e_cdr_20250714', '/export_dir', 'holdtime >= 100');
CALL ExportCallData('e_cdr_20250807', '/export_dir', 'holdtime >= 100');
