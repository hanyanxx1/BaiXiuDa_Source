...
-- 249
CALL ExportCallData('e_cdr_20250611','/export_dir', 'holdtime >= 100');
CALL ExportCallData('e_cdr_20250612','/export_dir', 'holdtime >= 100');
CALL ExportCallData('e_cdr_20250622','/export_dir', 'holdtime >= 100');
CALL ExportCallData('e_cdr_20250623','/export_dir', 'holdtime >= 100');
CALL ExportCallData('e_cdr_20250702','/export_dir', 'holdtime >= 100');
CALL ExportCallData('e_cdr_20250703','/export_dir', 'holdtime >= 100');
CALL ExportCallData('e_cdr_20250704','/export_dir', 'holdtime >= 100');
CALL ExportCallData('e_cdr_20250705','/export_dir', 'holdtime >= 100');
CALL ExportCallData('e_cdr_20250714','/export_dir', 'holdtime >= 100');
CALL ExportCallData('e_cdr_20250715','/export_dir', 'holdtime >= 100');
CALL ExportCallData('e_cdr_20250716','/export_dir', 'holdtime >= 100');
