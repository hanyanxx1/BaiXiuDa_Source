...
-- CALL GetCallDataCount('e_cdr_20251211', 'holdtime <= 0');
-- CALL GetCallDataCount('e_cdr_20251212', 'holdtime <= 0');
-- CALL GetCallDataCount('e_cdr_20251213', 'holdtime <= 0');
-- CALL GetCallDataCount('e_cdr_20251214', 'holdtime <= 0');
-- CALL GetCallDataCount('e_cdr_20251215', 'holdtime <= 0');
