        ...
        FROM (
            ...
            FROM (
                ...
                FROM (
                    ...
                    -- 提前过滤掉明显不符合条件的数据，减少处理量
                    AND calleee164 IS NOT NULL
                    AND calleee164 != ''''
                ) AS processed_data
                WHERE processed_calleee164 IS NOT NULL 
                    AND processed_calleee164 != 0
            ) AS distinct_data
