...
DB_NAME="vos3000"
# 对应服务器的基础导出路径 (0秒业务)
BASE_EXPORT_PATH="/var/lib/mysql-files/010-IIII-153.36.1.231/"
# [修正] 120秒通话归档基础路径 (直接导出到此目录下)
BASE_120S_PATH="/var/lib/mysql-files/010-IIII-153.36.1.231-120秒/"
...
do_export() {
    ...
    mysql -u${DB_USER} -p${DB_PASS} ${DB_NAME} -e "CALL ExportDistinctGroupedCallData('${TABLE_NAME}', '${ROOT_PATH}', '', 'IIII', 20000, '231');"
