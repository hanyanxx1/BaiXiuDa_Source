...
-- CALL ExportDistinctGroupedCallData ( 'e_cdr_20260407', '/var/lib/mysql-files/e_cdr_20260407/', 'holdtime <= 0', 'QQQQ', 20000, '247' );

-- -- 示例 2: 不传条件，查全表导出，小分组前缀 'QQQQ'，每批2万条，服务标识 '247'
-- CALL ExportDistinctGroupedCallData ( 'e_cdr_20260407', '/var/lib/mysql-files/', '', 'QQQQ', 20000, '247' );
