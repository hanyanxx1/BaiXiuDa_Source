...
-- 39
-- CALL ExportDistinctGroupedCallData('e_cdr_20260122','/var/lib/mysql-files/e_cdr_20260122/','holdtime <= 0');
-- CALL ExportDistinctGroupedCallData('e_cdr_20260123','/var/lib/mysql-files/e_cdr_20260123/','holdtime <= 0');
-- CALL ExportDistinctGroupedCallData('e_cdr_20260124','/var/lib/mysql-files/e_cdr_20260124/','holdtime <= 0');
-- CALL ExportDistinctGroupedCallData('e_cdr_20260125','/var/lib/mysql-files/e_cdr_20260125/','holdtime <= 0');
-- CALL ExportDistinctGroupedCallData('e_cdr_20260126','/var/lib/mysql-files/e_cdr_20260126/','holdtime <= 0');
-- CALL ExportDistinctGroupedCallData('e_cdr_20260127','/var/lib/mysql-files/e_cdr_20260127/','holdtime <= 0');
-- CALL ExportDistinctGroupedCallData('e_cdr_20260128','/var/lib/mysql-files/e_cdr_20260128/','holdtime <= 0');
-- CALL ExportDistinctGroupedCallData('e_cdr_20260129','/var/lib/mysql-files/e_cdr_20260129/','holdtime <= 0');
-- CALL ExportDistinctGroupedCallData('e_cdr_20260130','/var/lib/mysql-files/e_cdr_20260130/','holdtime <= 0');
-- CALL ExportDistinctGroupedCallData('e_cdr_20260131','/var/lib/mysql-files/e_cdr_20260131/','holdtime <= 0');
-- CALL ExportDistinctGroupedCallData('e_cdr_20260201','/var/lib/mysql-files/e_cdr_20260201/','holdtime <= 0');
-- CALL ExportDistinctGroupedCallData('e_cdr_20260202','/var/lib/mysql-files/e_cdr_20260202/','holdtime <= 0');
-- CALL ExportDistinctGroupedCallData('e_cdr_20260203','/var/lib/mysql-files/e_cdr_20260203/','holdtime <= 0');
-- CALL ExportDistinctGroupedCallData('e_cdr_20260204','/var/lib/mysql-files/e_cdr_20260204/','holdtime <= 0');
CALL ExportDistinctGroupedCallData('e_cdr_20260205','/var/lib/mysql-files/e_cdr_20260205/','holdtime <= 0');
CALL ExportDistinctGroupedCallData('e_cdr_20260206','/var/lib/mysql-files/e_cdr_20260206/','holdtime <= 0');
CALL ExportDistinctGroupedCallData('e_cdr_20260207','/var/lib/mysql-files/e_cdr_20260207/','holdtime <= 0');
CALL ExportDistinctGroupedCallData('e_cdr_20260208','/var/lib/mysql-files/e_cdr_20260208/','holdtime <= 0');
CALL ExportDistinctGroupedCallData('e_cdr_20260209','/var/lib/mysql-files/e_cdr_20260209/','holdtime <= 0');
CALL ExportDistinctGroupedCallData('e_cdr_20260210','/var/lib/mysql-files/e_cdr_20260210/','holdtime <= 0');
CALL ExportDistinctGroupedCallData('e_cdr_20260211','/var/lib/mysql-files/e_cdr_20260211/','holdtime <= 0');
CALL ExportDistinctGroupedCallData('e_cdr_20260212','/var/lib/mysql-files/e_cdr_20260212/','holdtime <= 0');
CALL ExportDistinctGroupedCallData('e_cdr_20260213','/var/lib/mysql-files/e_cdr_20260213/','holdtime <= 0');
CALL ExportDistinctGroupedCallData('e_cdr_20260214','/var/lib/mysql-files/e_cdr_20260214/','holdtime <= 0');
CALL ExportDistinctGroupedCallData('e_cdr_20260215','/var/lib/mysql-files/e_cdr_20260215/','holdtime <= 0');
CALL ExportDistinctGroupedCallData('e_cdr_20260216','/var/lib/mysql-files/e_cdr_20260216/','holdtime <= 0');
CALL ExportDistinctGroupedCallData('e_cdr_20260217','/var/lib/mysql-files/e_cdr_20260217/','holdtime <= 0');
CALL ExportDistinctGroupedCallData('e_cdr_20260218','/var/lib/mysql-files/e_cdr_20260218/','holdtime <= 0');
CALL ExportDistinctGroupedCallData('e_cdr_20260219','/var/lib/mysql-files/e_cdr_20260219/','holdtime <= 0');
CALL ExportDistinctGroupedCallData('e_cdr_20260220','/var/lib/mysql-files/e_cdr_20260220/','holdtime <= 0');
CALL ExportDistinctGroupedCallData('e_cdr_20260221','/var/lib/mysql-files/e_cdr_20260206/','holdtime <= 0');
