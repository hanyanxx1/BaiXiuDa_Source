...
-- 39
CALL ExportCallData('e_cdr_20251209', '/var/lib/mysql-files/', 'holdtime >= 100');
CALL ExportCallData('e_cdr_20251210', '/var/lib/mysql-files/', 'holdtime >= 100');
CALL ExportCallData('e_cdr_20251211', '/var/lib/mysql-files/', 'holdtime >= 100');
CALL ExportCallData('e_cdr_20251212', '/var/lib/mysql-files/', 'holdtime >= 100');
