	...
	var e = t.document,
		...
		a = function() {
			var t = e.currentScript ? e.currentScript.src : function() {
				for(var t, r = e.scripts, n = r.length - 1, o = n; o > 0; o--)
					if("interactive" === r[o].readyState) {
						t = r[o].src;
						break
					}
				return t || r[n].src
...
! function(e, t) {
	...
	r.formatArr = function(e) {
		...
		u(), "string" == typeof y && y ? n.EXP_IF.test(y) ? i.range ? (y = y.split(" " + n.rangeStr + " "), lay.each([i.dateTime, n.endDate], function(e, t) {
				c(t, y[e], e)
			})) : c(o, y) : (n.hint(r.formatError[0] + (i.range ? i.format + " " + n.rangeStr + " " + i.format : i.format) + r.formatError[1]), a = !0) : y && y.constructor === Date ? i.dateTime = n.systemDate(y) : (i.dateTime = n.systemDate(), delete n.startTime, delete n.endDate, u(), delete n.endTime),
			function() {
				if(n.rangeElem) {
					var e = [n.rangeElem[0].val(), n.rangeElem[1].val()],
